...
This is a Ruby on Rails 8.1.3.1 application, running on Ruby 4.0.5 and using PostgreSQL.
...
Run the non-system test suite with:
...
the Rails 8.1 upgrade verification.
